  ...
  const testimonials: Testimonial[] = [
    {
      ...
      media: [
        { type: "audio", url: "/media/audios/fgAdvogados/fg_advogados_01.ogg" },
        { type: "audio", url: "/media/audios/fgAdvogados/fg_advogados_02.ogg" },
        { type: "image", url: "/media/images/fgAdvogados/fg_advogados_01.jpeg" },
        { type: "image", url: "/media/images/fgAdvogados/fg_advogados_02.jpeg" }
      ],
    },
    /*{
    ...
    },*/
    {
      ...
      media: [
        { type: "video", url: "/media/videos/WA_ADV/wa_adv_01.mp4" },
        { type: "audio", url: "/media/audios/WA_ADV/wa_adv_01.ogg" },
        { type: "image", url: "/media/images/WA_ADV/wa_adv_01.png" }
      ],
    },
  ];
